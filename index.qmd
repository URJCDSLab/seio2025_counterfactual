...
author: "E. López Cano, J. Saugar, C. Lancho Martín, M. Cuesta, I. Martín de Diego, A. Amado"
...
* A compound indicator by dimension $y_i$ is computed then as a weighted average:

$$y = \sum w_i x_i$$
* The Global Sustainable Tourism Indicator (STI) is the weighted average of the $p$ dimensions indicators:
